...
Revision ID: 1573403f6611
Revises: 
Create Date: 2025-06-08 00:45:00.414914
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nome_participante', sa.String(length=100), nullable=False),
    sa.Column('sobrenome_participante', sa.String(length=100), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('cpf', 'evento_id', name='uq_cpf_evento')
    )
